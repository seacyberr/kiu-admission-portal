          ...
          <Card className="p-6">
              ...
              <div className="grid grid-cols-1 gap-3">
                <div className="p-3 rounded-lg bg-blue-50 border border-blue-200">
                  ...
                  <ul className="text-xs text-blue-700 space-y-0.5">
                    ...
                    <li>• Progress to Diploma / Bachelor Degree</li>
                  </ul>
                </div>
                <div className="p-3 rounded-lg bg-amber-50 border border-amber-200">
                  <p className="text-xs font-bold text-amber-800 mb-1">✅ Diploma Level 5</p>
                  <ul className="text-xs text-amber-700 space-y-0.5">
                    <li>• Progress from HEC</li>
                    <li>• 2 Years program</li>
            ...
            <div className="mb-5 p-3 rounded-xl bg-blue-50 border border-blue-200 flex items-start gap-2">
              ...
              <div className="text-xs text-blue-700 space-y-1">
                <p className="font-semibold">HEC Grade Requirements:</p>
                <p>• Minimum 1 pass at Principal level</p>
                <p>• Or minimum 2 passes at Subsidiary level</p>
